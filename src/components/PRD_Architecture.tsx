              ...
              <div className="p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 rounded-lg space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-xs">
                  <div className="p-2.5 bg-white dark:bg-slate-900 border rounded font-mono">
                    ...
                    <span className="block mt-1">Username: <b className="text-slate-900 dark:text-white select-all">admin</b></span>
                  ...
                  <div className="p-2.5 bg-white dark:bg-slate-900 border rounded font-mono">
                    ...
                    <span className="block text-[10px] text-slate-400 italic">(Scholar: Sample Student)</span>
                  </div>
                </div>
              </div>
